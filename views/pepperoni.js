	...
	return (
		<View>
			...
			<View style={styles.desription}>
				<Text style={{ fontSize: 25 }}>Pizza Pepperoni</Text>
				<Text style={{ fontSize: 15 }}>13,99 €</Text>
				<Text style={{ fontSize: 20, marginTop: 20 }}>
					Sauce tomate, mozzarella, pepperoni au boeuf, origans.
				</Text>
			</View>
